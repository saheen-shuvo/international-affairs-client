      ...
      <div className="pt-2 lg:pt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="card bg-base-100 shadow-sm">
          ...
          <div className="card-body">
            ...
            <p>
              Join IIP 2025 and kickstart your global career journey through
              impactful international internships. Gain real-world experience,
              build cross-cultural skills, and grow professionally as you
              contribute to meaningful projects around the world.
            </p>
            <div className="card-actions justify-end">
              <Link to="/iip/iip2025details">
